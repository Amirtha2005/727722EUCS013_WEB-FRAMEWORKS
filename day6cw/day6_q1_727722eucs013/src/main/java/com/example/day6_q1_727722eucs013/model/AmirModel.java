package com.example.day6_q1_727722eucs013.model;
...
public class AmirModel {
     ...
     public AmirModel(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
